...
Recall that if $X$ has the *beta distribution* with shape parameters $\alpha$ and $\beta$, i.e., $X\sym\operatorname{Beta}(\alpha,\beta)$, then $X$ has probability density function
